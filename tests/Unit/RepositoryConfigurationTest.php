...
describe('Repository Configuration', function () {
    test('resolves file repository when storage is set to file', function () {
    ...
    test('resolves database repository when storage is set to database', function () {
    ...
    test('defaults to file repository when storage config is not set', function () {
    ...
    test('defaults to file repository when storage config is invalid', function () {
    ...
    test('repository binding creates new instances each time', function () {
        config(['redirects.storage' => 'file']);
    ...
    test('repository type changes when config is changed at runtime', function () {
